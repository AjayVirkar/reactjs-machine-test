  ...
  return (
    ...
    <footer className="text-center lg:text-left bg-gray-300 text-gray-600">
      ...
      <div className="mx-6 py-10 text-center md:text-left">
        <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          ">
            ...
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minima similique dolores possimus voluptas ratione aperiam accusamus cupiditate iure quasi, quae aspernatur du</p>
          </div>
          <div className="">
            ...
            <p className="mb-4">
              <a href="#!" className="text-gray-600">ReactJs</a>
            </p>
            <p className="mb-4">
              <a href="#!" className="text-gray-600">NextJs</a>
            </p>
            <p className="mb-4">
              <a href="#!" className="text-gray-600">VueJs</a>
            </p>
            <p>
              <a href="#!" className="text-gray-600">NuxtJs</a>
            </p>
          </div>
          <div className="">
            <h6 className="uppercase font-semibold mb-4 flex justify-center md:justify-start">
      ...
      <div className="text-center p-6 bg-gray-200">
        <span>© 2023 Copyright:Ajay Virkar </span>
        <a className="text-gray-600 font-semibold" href="https://tailwind-elements.com/">Private Company</a>
      </div>
    </footer>
  )
}
